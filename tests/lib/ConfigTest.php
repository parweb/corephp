...
class ConfigTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        Config::set ( 'application.environment', 'production' );
        $this->assertEquals ( 'production', Config::get ( 'application.environment' ) );
    }
    
    public function testGetWithDefaultValue ()
    {
        $this->assertEquals ( 'default value', Config::get ( 'undefined key', 'default value' ) );
    }
}
